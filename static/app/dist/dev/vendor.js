...
(window.webpackJsonp = window.webpackJsonp || []).push([[4], {
  "10": function (e, t) {
    e.exports = function (e) {
      ...
      try {
        if (typeof execScript != "undefined" && n()) {
          execScript(e);
  ...
  "204": function (e, t, n) {
    ...
    function r(e, t) {
      ...
      var r = e[3];
      if (r) {
        return (t && typeof btoa == "function" ? (e = a(r), t = r.sources.map(function (e) {
  ...
  "205": function (e, t, n) {
    ...
    var a = function (e) {
      var t;
      return function () {
        return t = t === undefined ? e.apply(this, arguments) : t;
      };
    }(function () {
      ...
      for (var n = 0; n < e.length; n++) {
        ...
        if (a) {
          ...
          for (; i < r.parts.length; i++) {
            a.parts.push(x(r.parts[i], t));
          }
        } else {
          var o = [];
          for (var i = 0; i < r.parts.length; i++) {
            o.push(x(r.parts[i], t));
          }
          c[r.id] = {
            id: r.id,
            refs: 1,
    ...
    function m(e) {
      ...
      if (e.attrs.nonce === undefined && (t = y())) {
        e.attrs.nonce = t;
      }
      v(n, e.attrs);
      h(e, n);
    ...
    function x(t, e) {
      ...
      if (e.transform && t.css) {
        if (!(n = typeof e.transform == "function" ? e.transform(t.css) : e.transform.default(t.css))) {
          return function () {};
        }
        t.css = n;
      }
      i = e.singleton ? (n = l++, r = s = s || m(e), a = k.bind(null, r, n, false), k.bind(null, r, n, true)) : t.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (r = b(e), a = T.bind(null, r, e), function () {
        g(r);
        if (r.href) {
          URL.revokeObjectURL(r.href);
        }
      }) : (r = m(e), a = $.bind(null, r), function () {
        g(r);
      });
      a(t);
      return function o(e) {
    ...
    e.exports = function (e, o) {
      ...
      (o = o || {}).attrs = typeof o.attrs == "object" ? o.attrs : {};
  ...
  "206": function (e, t, n) {
    ...
    var x = [[r.default, {}], [a.default, {}], [i.default, {
      enabled: true,
      label: true
    }], [o.default, {}], [s.default, {}], [u.default, {}], [d.default, {}], [p.default, {}], [f.default, {}], [h.default, {}], [g.default], [m.default, {
      attrs: {
        target: "_blank"
      }
    }], [b.default], [v.default], [n.default]];
    var r = (0, c.default)();
    _.each(r, function (e) {
      x.push([l.default, e.type, e.parse]);
    });
    t.default = x;
  },
  "207": function (e, t, n) {
    ...
    function o(e, t) {
      ...
      var r = true;
      var a = true;
      var i = t > 0 ? e.src.charCodeAt(t - 1) : -1;
      var n = t + 1 <= n ? e.src.charCodeAt(t + 1) : -1;
      return {
        can_open: r = n !== 32 && n !== 9 ? r : false,
        can_close: a = i === 32 || i === 9 || n >= 48 && n <= 57 ? false : a
      };
    }
    function s(e, t) {
      var n;
      ...
      if (o(e, e.pos).can_open) {
        for (r = n = e.pos + 1; (r = e.src.indexOf("$", r)) !== -1;) {
          for (i = r - 1; e.src[i] === "\\";) {
            --i;
          }
          if ((r - i) % 2 == 1) {
        ...
        if (r === -1) {
          ...
          e.pos = n + 1;
        } else if (o(e, r).can_close) {
          if (!t) {
            (a = e.push("math_inline", "math", 0)).markup = "$";
            a.content = e.src.slice(n, r);
          }
          e.pos = r + 1;
        } else {
          if (!t) {
    ...
    function l(e, t, n, r) {
      ...
      if (!r) {
        ...
        o = t;
        while (!l && !(n <= ++o) && (!((c = e.bMarks[o] + e.tShift[o]) < (u = e.eMarks[o])) || !(e.tShift[o] < e.blkIndent))) {
          if (e.src.slice(c, u).trim().slice(-2) === "$$") {
            s = e.src.slice(0, u).lastIndexOf("$$");
            i = e.src.slice(c, s);
            l = true;
          }
        }
        e.line = o + 1;
        (r = e.push("math_block", "math", 0)).block = true;
        r.content = (a && a.trim() ? a + "\n" : "") + e.getLines(t + 1, o, e.tShift[t], true) + (i && i.trim() ? i : "");
        r.map = [t, e.line];
        r.markup = "$$";
      }
      return true;
    ...
    function r(e, n) {
      ...
      var r = function r(e) {
        n.displayMode = false;
        try {
          return katex.renderToString(e, n);
        } catch (t) {
          if (n.throwOnError) {
            console.log(t);
          }
          return "<span class='katex-error' title='" + c(t.toString()) + "'>" + c(e) + "</span>";
        }
      };
      ...
      var i = function i(e) {
        n.displayMode = true;
        try {
          return "<p class='katex-block'>" + katex.renderToString(e, n) + "</p>";
        } catch (t) {
          if (n.throwOnError) {
            console.log(t);
          }
          return "<p class='katex-block katex-error' title='" + c(t.toString()) + "'>" + c(e) + "</p>";
        }
      };
      var o = function o(e, t) {
        return i(e[t].content) + "\n";
      };
      e.inline.ruler.after("escape", "math_inline", s);
      e.block.ruler.after("blockquote", "math_block", l, {
        alt: ["paragraph", "reference", "blockquote", "list"]
      });
      e.renderer.rules.math_inline = a;
  ...
  "208": function (e, t, n) {
    ...
    t.default = function (e) {
      function t(e, t) {
        ...
        a = (r = e.scanDelims(e.pos, true)).length;
        i = String.fromCharCode(s);
        if (a < 2) {
          return false;
        }
        if (a % 2) {
          e.push("text", "", 0).content = i;
          a--;
        }
        n = 0;
        for (; n < a; n += 2) {
      ...
      function n(e) {
        ...
        var i = [];
        var o = e.delimiters;
        for (var s = e.delimiters.length, l = 0; l < s; l++) {
          if ((n = o[l]).marker === 61 && n.end !== -1 && (r = o[n.end], (a = e.tokens[n.token]).type = "mark_open", a.tag = "mark", a.nesting = 1, a.markup = "==", a.content = "", (a = e.tokens[r.token]).type = "mark_close", a.tag = "mark", a.nesting = -1, a.markup = "==", a.content = "", e.tokens[r.token - 1].type === "text") && e.tokens[r.token - 1].content === "=") {
            i.push(r.token - 1);
          }
        }
        while (i.length) {
          for (t = (l = i.pop()) + 1; t < e.tokens.length && e.tokens[t].type === "mark_close";) {
            t++;
          }
          if (l !== --t) {
            a = e.tokens[t];
            e.tokens[t] = e.tokens[l];
            e.tokens[l] = a;
          }
        }
      }
  ...
  "209": function (e, t, n) {
    ...
    r = function () {
      return s({
        "1": [function (e, t, n) {
          ...
          function l(e, t) {
            return h(e[t]) && g(e[t - 1]) && m(e[t - 2]) && b(e[t]);
          }
          function c(e, t) {
            var n;
            e.children.unshift(u(e, t));
            e.children[1].content = e.children[1].content.slice(3);
            e.content = e.content.slice(3);
            if (a) {
              if (i) {
                e.children.pop();
                n = "task-item-" + Math.ceil(Math.random() * 10000000 - 1000);
                e.children[0].content = e.children[0].content.slice(0, -1) + " id=\"" + n + "\">";
                e.children.push(f(e.content, n, t));
              } else {
                e.children.unshift(d(t));
                e.children.push(p(t));
              }
            }
          }
          function u(e, t) {
            var t = new t("html_inline", "", 0);
            var n = r ? " disabled=\"\" " : "";
            if (e.content.indexOf("[ ] ") === 0) {
              t.content = "<input class=\"task-list-item-checkbox\"" + n + "type=\"checkbox\">";
            } else if (e.content.indexOf("[x] ") === 0 || e.content.indexOf("[X] ") === 0) {
              t.content = "<input class=\"task-list-item-checkbox\" checked=\"\"" + n + "type=\"checkbox\">";
            }
            return t;
          }
          function d(e) {
            e = new e("html_inline", "", 0);
            e.content = "<label>";
            return e;
          }
          function p(e) {
          ...
          function f(e, t, n) {
            n = new n("html_inline", "", 0);
            n.content = "<label class=\"task-list-item-label\" for=\"" + t + "\">" + e + "</label>";
            n.attrs = [{
              for: t
            }];
            return n;
          ...
          t.exports = function (e, t) {
            ...
            e.core.ruler.after("inline", "github-task-lists", function (e) {
              for (var t = e.tokens, n = 2; n < t.length; n++) {
                if (l(t, n)) {
                  c(t[n], e.Token);
                  o(t[n - 2], "class", "task-list-item" + (r ? "" : " enabled"));
                  o(t[s(t, n - 2)], "class", "contains-task-list");
                }
              }
            });
          };
      ...
      function s(r, t, a) {
        function i(n, e) {
          if (!t[n]) {
            ...
            r[n][0].call(e.exports, function (e) {
              var t = r[n][1][e];
              return i(t || e);
            }, e, e.exports, s, r, t, a);
          }
    ...
    if (a(t) === "object" && e !== undefined) {
      e.exports = r();
    } else {
      a = [];
      if ((t = typeof (r = r) == "function" ? r.apply(t, a) : r) !== undefined) {
        e.exports = t;
      }
    }
  },
      ...
      return function s(r, t, a) {
        ...
        "1": [function (e, t, n) {
          ...
          function r(e, t) {
            ...
            if (!n || a + 1 === e.pos || (t = e.src.slice(a + 1, e.pos)).match(/(^|[^\\])(\\\\)*\s/)) {
              e.pos = a;
              return false;
            } else {
              e.posMax = e.pos;
              ...
              e.push("text", "", 0).content = t.replace(i, "$1");
  ...
  "212": function (e, t, n) {
    ...
    r = function () {
      return function s(r, t, a) {
        ...
        "1": [function (e, t, n) {
          t.exports = function i(e, h, t) {
            function n(e) {
              return e.trim().split(" ", 2)[0] === h;
            }
            function r(e, t, n, r, a) {
              if (e[t].nesting === 1) {
                e[t].attrPush(["class", h]);
              }
              return a.renderToken(e, t, n, r, a);
            }
            var g = 3;
            var m = (t = t || {}).marker || ":";
            ...
            function a(e, t, n, r) {
              ...
              var u;
              var d = false;
              var p = e.bMarks[t] + e.tShift[t];
              var f = e.eMarks[t];
              if (b !== e.src.charCodeAt(p)) {
                return false;
              }
              for (a = p + 1; a <= f && m[(a - p) % v] === e.src[a]; a++);
              if ((o = Math.floor((a - p) / v)) < g) {
                return false;
              }
              a -= (a - p) % v;
              s = e.src.slice(p, a);
              ...
              if (!r) {
                for (i = t; !(n <= ++i) && (!((p = e.bMarks[i] + e.tShift[i]) < (f = e.eMarks[i])) || !(e.sCount[i] < e.blkIndent));) {
                  if (b === e.src.charCodeAt(p) && !(e.sCount[i] - e.blkIndent >= 4)) {
                    for (a = p + 1; a <= f && m[(a - p) % v] === e.src[a]; a++);
                    if (!(Math.floor((a - p) / v) < o) && !(a -= (a - p) % v, (a = e.skipSpaces(a)) < f)) {
                      d = true;
                      break;
                    }
                  }
                ...
                e.lineMax = i;
                (c = e.push("container_" + h + "_open", "div", 1)).markup = s;
                c.block = true;
                c.info = l;
                c.map = [t, i];
                e.md.block.tokenize(e, t + 1, i);
                (c = e.push("container_" + h + "_close", "div", -1)).markup = e.src.slice(p, a);
                c.block = true;
                e.parentType = r;
                e.lineMax = u;
                e.line = i + (d ? 1 : 0);
            ...
            e.block.ruler.before("fence", "container_" + h, a, {
              alt: ["paragraph", "reference", "blockquote", "list"]
            });
            e.renderer.rules["container_" + h + "_open"] = t;
            e.renderer.rules["container_" + h + "_close"] = t;
          };
        }, {}]
      }, {}, [1])(1);
    };
    ...
    var i = function i(n, r) {
      return {
        ...
        render: function a(e, t) {
          if (e[t].nesting === 1) {
            return "<div class=\"markdown-alert markdown-alert-" + n + "\">" + ("<i class=\"markdown-alert-icon markdown-alert-icon-" + n + "\">" + r + "</i>");
          } else {
            return "</div>";
          }
        }
  ...
  "214": function (e, t, n) {
    ...
    r = function () {
      return function s(r, t, a) {
          ...
          t.exports = function o(r) {
            ...
            if (r.enabled.length) {
              a = Object.keys(a).reduce(function (e, t) {
                if (r.enabled.indexOf(t) >= 0) {
                  e[t] = a[t];
                }
                return e;
              }, {});
            }
            e = Object.keys(r.shortcuts).reduce(function (t, n) {
              if (a[n]) {
                if (Array.isArray(r.shortcuts[n])) {
                  r.shortcuts[n].forEach(function (e) {
                    t[e] = n;
                  });
                } else {
                  t[r.shortcuts[n]] = n;
            ...
            var t = Object.keys(a).map(function (e) {
              return ":" + e + ":";
            }).concat(Object.keys(e)).sort().reverse().map(function (e) {
              return i(e);
            }).join("|");
            var n = RegExp(t);
            var t = RegExp(t, "g");
        ...
        "5": [function (e, t, n) {
          t.exports = function r(e, c, u, l, t) {
            var d = e.utils.arrayReplaceAt;
            var e = e.utils.lib.ucmicro;
            var p = new RegExp([e.Z.source, e.P.source, e.Cc.source].join("|"));
            function f(a, e, i) {
              var o;
              var s = 0;
              var l = [];
              a.replace(t, function (e, t, n) {
                var r;
                if (u.hasOwnProperty(e)) {
                  ...
                  if (t + e.length < n.length && !p.test(n[t + e.length])) {
                    return;
                  }
                } else {
                  r = e.slice(1, -1);
                ...
                if (s < t) {
                  (o = new i("text", "", 0)).content = a.slice(s, t);
                  l.push(o);
                }
                (o = new i("emoji", "", 0)).markup = r;
                o.content = c[r];
                l.push(o);
                s = t + e.length;
              });
              if (s < a.length) {
                (o = new i("text", "", 0)).content = a.slice(s);
                l.push(o);
              }
              return l;
            }
            return function h(e) {
              ...
              for (var o = 0, s = a.length; o < s; o++) {
                if (a[o].type === "inline") {
                  for (t = (n = a[o].children).length - 1; t >= 0; t--) {
                    if ((r = n[t]).type === "link_open" || r.type === "link_close") {
                      if (r.info === "auto") {
                        i -= r.nesting;
                      }
                    }
                    if (r.type === "text" && i === 0 && l.test(r.content)) {
                      a[o].children = n = d(n, t, f(r.content, r.level, e.Token));
                    }
                  }
                }
              }
        ...
        "6": [function (e, t, n) {
          var r = e("./lib/data/light.json");
          var a = e("./lib/data/shortcuts");
          var i = e("./lib/render");
          var o = e("./lib/replace");
          var s = e("./lib/normalize_opts");
          t.exports = function l(e, t) {
            ...
            var n = s(e.utils.assign({}, n, t || {}));
            e.renderer.rules.emoji = i;
            e.core.ruler.push("emoji", o(e, n.defs, n.shortcuts, n.scanRE, n.replaceRE));
          };
        }, {
        ...
        "1": [function (e, t, n) {
          t.exports = function r(e) {
            ...
            function n(e) {
              ...
              var o = e.delimiters;
              for (var s = e.delimiters.length, l = 0; l < s; l++) {
                if ((n = o[l]).marker === 43 && n.end !== -1 && (r = o[n.end], (a = e.tokens[n.token]).type = "ins_open", a.tag = "ins", a.nesting = 1, a.markup = "++", a.content = "", (a = e.tokens[r.token]).type = "ins_close", a.tag = "ins", a.nesting = -1, a.markup = "++", a.content = "", e.tokens[r.token - 1].type === "text") && e.tokens[r.token - 1].content === "+") {
                  i.push(r.token - 1);
                }
              }
              while (i.length) {
                for (t = (l = i.pop()) + 1; t < e.tokens.length && e.tokens[t].type === "ins_close";) {
                  t++;
                }
                if (l !== --t) {
                  a = e.tokens[t];
  ...
  "216": function (e, t, n) {
    ...
    r = function () {
      return function s(r, t, a) {
        ...
        "1": [function (e, t, n) {
          t.exports = function r(e) {
            var g = e.utils.escapeRE;
            var m = e.utils.arrayReplaceAt;
            var b = " \r\n$+<=>^`|~";
            var v = e.utils.lib.ucmicro.P.source;
            var y = e.utils.lib.ucmicro.Z.source;
            function t(e, t, n, r) {
              var a;
              var i;
              var o;
              ...
              if (e.src.charCodeAt(s++) !== 42) {
                return false;
              }
              if (e.src.charCodeAt(s++) !== 91) {
                return false;
              }
              for (i = s; s < l; s++) {
                if ((a = e.src.charCodeAt(s)) === 91) {
                  return false;
                }
                if (a === 93) {
                  o = s;
              ...
              if (o < 0 || e.src.charCodeAt(o + 1) !== 58) {
                return false;
              }
              if (!r) {
                r = e.src.slice(i, o).replace(/\\(.)/g, "$1");
                i = e.src.slice(o + 2, l).trim();
                if (r.length === 0) {
                  return false;
                }
                if (i.length === 0) {
                ...
                e.env.abbreviations ||= {};
                if (typeof e.env.abbreviations[":" + r] == "undefined") {
                  e.env.abbreviations[":" + r] = i;
                }
                e.line = t + 1;
              }
              return true;
            ...
            function n(e) {
              ...
              if (e.env.abbreviations) {
                p = new RegExp("(?:" + Object.keys(e.env.abbreviations).map(function (e) {
                  return e.substr(1);
                }).sort(function (e, t) {
                  return t.length - e.length;
                }).map(g).join("|") + ")");
                d = "(^|" + v + "|" + y + "|[" + b.split("").map(g).join("") + "])(" + Object.keys(e.env.abbreviations).map(function (e) {
                  return e.substr(1);
                }).sort(function (e, t) {
                  return t.length - e.length;
                }).map(g).join("|") + ")($|" + v + "|" + y + "|[" + b.split("").map(g).join("") + "])";
                c = new RegExp(d, "g");
                n = 0;
                r = h.length;
                for (; n < r; n++) {
                  if (h[n].type === "inline") {
                    for (t = (a = h[n].children).length - 1; t >= 0; t--) {
                      if ((f = a[t]).type === "text" && (o = f.content, c.lastIndex = l = 0, s = [], p.test(o))) {
                        while (u = c.exec(o)) {
                          if (u.index > 0 || u[1].length > 0) {
                            (i = new e.Token("text", "", 0)).content = o.slice(l, u.index + u[1].length);
                            s.push(i);
                          }
                          (i = new e.Token("abbr_open", "abbr", 1)).attrs = [["title", e.env.abbreviations[":" + u[2]]]];
                          s.push(i);
                          (i = new e.Token("text", "", 0)).content = u[2];
                          s.push(i);
                          i = new e.Token("abbr_close", "abbr", -1);
                          s.push(i);
                          c.lastIndex -= u[3].length;
                          l = c.lastIndex;
                        }
                        if (s.length) {
                          if (l < o.length) {
                            (i = new e.Token("text", "", 0)).content = o.slice(l);
                            s.push(i);
                          }
                          h[n].children = a = m(a, t, s);
                        }
                      }
                    }
                  }
  ...
  "217": function (e, t, n) {
    ...
    a = function () {
      return s({
        "1": [function (e, t, n) {
          function i(e) {
            return (i = typeof Symbol == "function" && o(Symbol.iterator) === "symbol" ? function i(e) {
              if (e === undefined) {
                return "undefined";
              } else {
                return o(e);
          ...
          function c(e, t, o) {
            ...
            var l = p(e, o.shift !== undefined ? t + o.shift : o.position);
            if (l !== undefined) {
              var n;
              var r = function r(t) {
                if (t === "shift" || t === "position") {
                  return "continue";
                }
                if (l[t] === undefined) {
                  return {
                ...
                if (t === "children" && u(o.children)) {
                  var e = function () {
                    ...
                    if (r.every(function (e) {
                      ...
                      if (n = r.every(function (e) {
                        return c(a, e.position, e).match;
                      })) {
                        e = f(r).position;
                        s.j = e >= 0 ? e : a.length + e;
                      }
                    } else {
                      var i = function i(t) {
                        if (n = r.every(function (e) {
                          return c(a, t, e).match;
                        })) {
                          s.j = t;
                          return "break";
                        }
                ...
                switch (i(o[t])) {
                  ...
                  default:
                    throw new Error(`Unknown type of pattern test (key: ${t}). Test should be of type boolean, number, string, function or array of functions.`);
                }
              };
              for (n in o) {
                var a = r(n);
                if (a !== "continue" && i(a) === "object") {
                  return a.v;
                }
              }
              s.match = true;
          ...
          t.exports = function l(e, t) {
            ...
            var n = Object.assign(n, t);
            var o = a(n);
            function r(e) {
              for (var a = e.tokens, i = function i(t) {
                  for (var e = 0; e < o.length; e++) {
                    var n = o[e];
                    var r = null;
                    if (n.tests.every(function (e) {
                      e = c(a, t, e);
                      if (e.j !== null) {
                        r = e.j;
                      }
                      ...
                      n.transform(a, t, r);
                      if (n.name === "inline attributes" || n.name === "inline nesting 0") {
                        e--;
                      }
                    }
                  }
            ...
            e.core.ruler.before("linkify", "curly_attributes", r);
          };
        }, {
          "./patterns.js": 2
        }],
        "2": [function (e, t, n) {
          ...
          t.exports = function (s) {
            var t = new RegExp("^ {0,3}[-*_]{3,} ?" + c.escapeRegExp(s.leftDelimiter) + "[^" + c.escapeRegExp(s.rightDelimiter) + "]");
            return [{
              name: "fenced code blocks",
              tests: [{
                shift: 0,
                block: true,
                info: c.hasDelimiters("end", s)
              }],
              transform: function l(e, t) {
                t = e[t];
                e = t.info.lastIndexOf(s.leftDelimiter);
                e = c.getAttrs(t.info, e, s);
                c.addAttrs(e, t);
                t.info = c.removeDelimiter(t.info, s);
              }
            }, {
              ...
              tests: [{
                ...
                children: [{
                  shift: -1,
                  type: function n(e) {
                    return e === "image" || e === "code_inline";
                  }
                }, {
                  shift: 0,
                  type: "text",
                  content: c.hasDelimiters("start", s)
                }]
              }],
              transform: function l(e, t, n) {
                var r = e[t].children[n];
                var a = r.content.indexOf(s.rightDelimiter);
                var i = e[t].children[n - 1];
                var o = c.getAttrs(r.content, 0, s);
                c.addAttrs(o, i);
                if (r.content.length === a + s.rightDelimiter.length) {
                  e[t].children.splice(n, 1);
                } else {
                  r.content = r.content.slice(a + s.rightDelimiter.length);
                }
              }
            }, {
              name: "tables",
              tests: [{
                ...
                shift: 2,
                type: "inline",
                content: c.hasDelimiters("only", s)
              }],
              transform: function l(e, t) {
                var n = e[t + 2];
                var r = c.getMatchingOpeningToken(e, t);
                var n = c.getAttrs(n.content, 0, s);
                c.addAttrs(n, r);
                e.splice(t + 1, 3);
              }
            }, {
              ...
              transform: function l(e, t, n) {
                var r = e[t].children[n];
                var a = r.content;
                var i = c.getAttrs(a, 0, s);
                var t = c.getMatchingOpeningToken(e[t].children, n - 1);
                c.addAttrs(i, t);
                r.content = a.slice(a.indexOf(s.rightDelimiter) + s.rightDelimiter.length);
              }
            }, {
              name: "list softbreak",
              tests: [{
              ...
              transform: function l(e, t, n) {
                var n = e[t].children[n].content;
                var n = c.getAttrs(n, 0, s);
                for (var r = t - 2; e[r - 1] && e[r - 1].type !== "ordered_list_open" && e[r - 1].type !== "bullet_list_open";) {
                  r--;
                }
                c.addAttrs(n, e[r - 1]);
                e[t].children = e[t].children.slice(0, -2);
              }
            }, {
              ...
              tests: [{
                shift: 0,
                type: function n(e) {
                  return e === "bullet_list_close" || e === "ordered_list_close";
                }
              }, {
                shift: 1,
                type: "paragraph_open"
              ...
              tests: [{
                ...
                children: [{
                  position: -1,
                  type: "text",
                  content: c.hasDelimiters("end", s)
                }]
              }],
              transform: function l(e, t, n) {
                var n = e[t].children[n];
                var r = n.content;
                var a = c.getAttrs(r, r.lastIndexOf(s.leftDelimiter), s);
                c.addAttrs(a, e[t - 2]);
                var a = r.slice(0, r.lastIndexOf(s.leftDelimiter));
                n.content = o(a) !== " " ? a : a.slice(0, -1);
              }
            }, {
              ...
              transform: function l(e, t, n) {
                var n = e[t].children[n];
                var n = c.getAttrs(n.content, 0, s);
                for (var r = t + 1; e[r + 1] && e[r + 1].nesting === -1;) {
                  r++;
                }
                var a = c.getMatchingOpeningToken(e, r);
                c.addAttrs(n, a);
                e[t].children = e[t].children.slice(0, -2);
              }
            }, {
              ...
              transform: function l(e, t) {
                ...
                n.nesting = 0;
                var r = e[t + 1].content;
                var a = r.lastIndexOf(s.leftDelimiter);
                n.attrs = c.getAttrs(r, a, s);
                n.markup = r;
                e.splice(t + 1, 2);
              }
            }, {
              ...
              transform: function l(e, t, n) {
                ...
                var r = n.content;
                var a = c.getAttrs(r, r.lastIndexOf(s.leftDelimiter), s);
                for (var i = t + 1; e[i + 1] && e[i + 1].nesting === -1;) {
                  i++;
                }
                t = c.getMatchingOpeningToken(e, i);
                c.addAttrs(a, t);
                a = r.slice(0, r.lastIndexOf(s.leftDelimiter));
                n.content = o(a) !== " " ? a : a.slice(0, -1);
              }
            }];
          };
        ...
        "3": [function (e, t, n) {
          ...
          n.getAttrs = function (e, t, n) {
            ...
            var p = true;
            var f = false;
            for (var h = t + n.leftDelimiter.length; h < e.length; h++) {
              if (e.slice(h, h + n.rightDelimiter.length) === n.rightDelimiter) {
                if (u !== "") {
                  c.push([u, d]);
                }
                break;
          ...
          n.addAttrs = function (e, t) {
            for (var n = 0, r = e.length; n < r; ++n) {
              var a = e[n][0];
              if (a === "class") {
                t.attrJoin("class", e[n][1]);
              } else if (a === "css-module") {
          ...
          n.hasDelimiters = function (s, l) {
            if (s) {
              return function (e) {
                var t;
                var n;
                var r;
                var a = l.leftDelimiter.length + 1 + l.rightDelimiter.length;
                if (!e || typeof e != "string" || e.length < a) {
                  return false;
                }
                function i(e) {
                  var t = e.charAt(l.leftDelimiter.length) === ".";
                  var n = e.charAt(l.leftDelimiter.length) === "#";
                  if (t || n) {
                    return e.length >= a + 1;
                  } else {
                    return e.length >= a;
                ...
                var o = a - l.rightDelimiter.length;
                switch (s) {
                  case "start":
                    n = (t = e.slice(0, l.leftDelimiter.length) === l.leftDelimiter ? 0 : -1) === -1 ? -1 : e.indexOf(l.rightDelimiter, o);
                    if ((r = e.charAt(n + l.rightDelimiter.length)) && l.rightDelimiter.indexOf(r) !== -1) {
                      n = -1;
                    }
                    break;
                  case "end":
                    n = (n = (t = e.lastIndexOf(l.leftDelimiter)) === -1 ? -1 : e.indexOf(l.rightDelimiter, t + o)) === e.length - l.rightDelimiter.length ? n : -1;
                    break;
                  case "only":
                    t = e.slice(0, l.leftDelimiter.length) === l.leftDelimiter ? 0 : -1;
                    n = e.slice(e.length - l.rightDelimiter.length) === l.rightDelimiter ? e.length - l.rightDelimiter.length : -1;
                }
                return t !== -1 && n !== -1 && i(e.substring(t, n + l.rightDelimiter.length));
              };
            }
            throw new Error("Parameter `where` not passed. Should be \"start\", \"middle\", \"end\" or \"only\".");
          };
          n.removeDelimiter = function (e, t) {
            var n = r(t.leftDelimiter);
            var t = r(t.rightDelimiter);
            var n = new RegExp("[ \\n]?" + n + "[^" + n + t + "]+" + t + "$");
            var t = e.search(n);
            if (t !== -1) {
              return e.slice(0, t);
          ...
          n.escapeRegExp = r;
          n.getMatchingOpeningToken = function (e, t) {
            ...
            var n = e[t].level;
            var r = e[t].type.replace("_close", "_open");
            for (; t >= 0; --t) {
      ...
      function s(n, r, a) {
        function i(t, e) {
          if (!r[t]) {
            ...
            n[t][0].call(e.exports, function (e) {
              return i(n[t][1][e] || e);
            }, e, e.exports, s, n, r, a);
          }
          return r[t].exports;
    ...
    if (o(t) === "object" && e !== undefined) {
      e.exports = a();
    } else {
      r = [];
      if ((t = typeof (a = a) == "function" ? a.apply(t, r) : a) !== undefined) {
        e.exports = t;
      }
    }
  },
  "218": function (e, t, n) {
    ...
    r = function () {
      return s({
        "1": [function (e, t, n) {
          function i(e, t, n, r) {
            t = Number(e[t].meta.id + 1).toString();
            e = "";
            return (e = typeof r.docId == "string" ? "-" + r.docId + "-" : e) + t;
          }
          function s(e, t) {
          ...
          function l(e, t, n, r, a) {
            var i = a.rules.footnote_anchor_name(e, t, n, r, a);
            var n = a.rules.footnote_caption(e, t, n, r, a);
            var r = i;
            if (e[t].meta.subId > 0) {
              r += ":" + e[t].meta.subId;
            }
            return "<sup class=\"footnote-ref\"><a href=\"#fn" + i + "\" id=\"fnref" + r + "\">" + n + "</a></sup>";
          }
          function c(e, t, n) {
          ...
          function d(e, t, n, r, a) {
            n = a.rules.footnote_anchor_name(e, t, n, r, a);
            if (e[t].meta.subId > 0) {
              n += ":" + e[t].meta.subId;
            }
          ...
          function f(e, t, n, r, a) {
            ...
            return " <a href=\"#fnref" + n + "\" class=\"footnote-backref\">↩︎</a>";
          }
          t.exports = function g(e) {
            var o = e.helpers.parseLinkLabel;
            var h = e.utils.isSpace;
            function t(e, t, n, r) {
              var a;
              var i;
              var o;
              ...
              if (e.src.charCodeAt(p) !== 91) {
                return false;
              }
              if (e.src.charCodeAt(p + 1) !== 94) {
                return false;
              }
              for (s = p + 2; s < f; s++) {
                if (e.src.charCodeAt(s) === 32) {
                  return false;
                }
                if (e.src.charCodeAt(s) === 93) {
                  break;
                }
              }
              if (s === p + 2) {
              ...
              if (f <= s + 1 || e.src.charCodeAt(++s) !== 58) {
                return false;
              }
              if (!r) {
                s++;
                e.env.footnotes ||= {};
                e.env.footnotes.refs ||= {};
                r = e.src.slice(p + 2, s - 2);
                e.env.footnotes.refs[":" + r] = -1;
                (p = new e.Token("footnote_reference_open", "", 1)).meta = {
                  label: r
                };
                p.level = e.level++;
                e.tokens.push(p);
                ...
                o = e.parentType;
                d = s;
                l = c = e.sCount[t] + s - (e.bMarks[t] + e.tShift[t]);
                while (s < f && (u = e.src.charCodeAt(s), h(u))) {
                  if (u === 9) {
                    c += 4 - c % 4;
                  } else {
                    c++;
                ...
                e.sCount[t] = i;
                e.bMarks[t] = r;
                (p = new e.Token("footnote_reference_close", "", -1)).level = --e.level;
                e.tokens.push(p);
              }
              return true;
            }
            function n(e, t) {
              ...
              var a = e.posMax;
              var i = e.pos;
              return !(a <= i + 2) && e.src.charCodeAt(i) === 94 && e.src.charCodeAt(i + 1) === 91 && !(n = i + 2, (i = o(e, i + 1)) < 0) && !(t || (e.env.footnotes ||= {}, e.env.footnotes.list ||= [], t = e.env.footnotes.list.length, e.md.inline.parse(e.src.slice(n, i), e.md, e.env, r = []), e.push("footnote_ref", "", 0).meta = {
                id: t
              }, e.env.footnotes.list[t] = {
                content: e.src.slice(n, i),
                tokens: r
              }), e.pos = i + 1, e.posMax = a, 0);
            }
            function r(e, t) {
              var n;
              var r;
              ...
              if (e.src.charCodeAt(i) !== 91) {
                return false;
              }
              if (e.src.charCodeAt(i + 1) !== 94) {
                return false;
              }
              for (n = i + 2; n < a; n++) {
                if (e.src.charCodeAt(n) === 32) {
                  return false;
                }
                if (e.src.charCodeAt(n) === 10) {
                  return false;
                }
                if (e.src.charCodeAt(n) === 93) {
                  break;
                }
              }
              return n !== i + 2 && !(a <= n) && !(i = e.src.slice(i + 2, ++n - 1), typeof e.env.footnotes.refs[":" + i] == "undefined") && !(t || (e.env.footnotes.list ||= [], e.env.footnotes.refs[":" + i] < 0 ? (r = e.env.footnotes.list.length, e.env.footnotes.list[r] = {
                label: i,
                count: 0
              }, e.env.footnotes.refs[":" + i] = r) : r = e.env.footnotes.refs[":" + i], t = e.env.footnotes.list[r].count, e.env.footnotes.list[r].count++, e.push("footnote_ref", "", 0).meta = {
                id: r,
                subId: t,
                label: i
              }), e.pos = n, e.posMax = a, 0);
            }
            function a(e) {
              var t;
              var n;
              ...
              if (e.env.footnotes && (e.tokens = e.tokens.filter(function (e) {
                if (e.type === "footnote_reference_open") {
                  d = true;
                  c = [];
                  u = e.meta.label;
                  return false;
                } else if (e.type === "footnote_reference_close") {
                  d = false;
                  p[":" + u] = c;
                  return false;
                } else {
                ...
                o = e.env.footnotes.list;
                s = new e.Token("footnote_block_open", "", 1);
                e.tokens.push(s);
                t = 0;
                n = o.length;
                for (; t < n; t++) {
                  (s = new e.Token("footnote_open", "", 1)).meta = {
                    id: t,
                    label: o[t].label
                  };
                  e.tokens.push(s);
                  if (o[t].tokens) {
                    l = [];
                    (s = new e.Token("paragraph_open", "p", 1)).block = true;
                    l.push(s);
                    (s = new e.Token("inline", "", 0)).children = o[t].tokens;
                    s.content = o[t].content;
                    l.push(s);
                    (s = new e.Token("paragraph_close", "p", -1)).block = true;
                    l.push(s);
                  } else if (o[t].label) {
                    l = p[":" + o[t].label];
                  }
                  ...
                  i = e.tokens[e.tokens.length - 1].type === "paragraph_close" ? e.tokens.pop() : null;
                  a = o[t].count > 0 ? o[t].count : 1;
                  r = 0;
                  for (; r < a; r++) {
                    (s = new e.Token("footnote_anchor", "", 0)).meta = {
                      id: t,
                      subId: r,
                      label: o[t].label
                    };
                ...
                s = new e.Token("footnote_block_close", "", -1);
                e.tokens.push(s);
              }
            }
            e.renderer.rules.footnote_ref = l;
            e.renderer.rules.footnote_block_open = c;
            e.renderer.rules.footnote_block_close = u;
            e.renderer.rules.footnote_open = d;
            e.renderer.rules.footnote_close = p;
            e.renderer.rules.footnote_anchor = f;
            e.renderer.rules.footnote_caption = s;
            e.renderer.rules.footnote_anchor_name = i;
            e.block.ruler.before("reference", "footnote_def", t, {
              alt: ["paragraph", "reference"]
            });
            e.inline.ruler.after("image", "footnote_inline", n);
            e.inline.ruler.after("footnote_inline", "footnote_ref", r);
            e.core.ruler.after("inline", "footnote_tail", a);
          };
        }, {}]
      }, {}, [1])(1);
      function s(n, r, a) {
        ...
        "1": [function (e, t, n) {
          t.exports = function r(e) {
            function t(e, t) {
              ...
              if (i === 45 && e.src.charCodeAt(a + 1) === 62) {
                e.scanDelims(e.pos, true);
                (n = e.push("text", "", 0)).content = "->";
                e.delimiters.push({
                  marker: n.content,
                  jump: 0,
                  token: e.tokens.length - 1,
                ...
                if (i !== 60 || e.src.charCodeAt(a + 1) !== 45) {
                  return false;
                }
                e.scanDelims(e.pos, true);
                (n = e.push("text", "", 0)).content = "<-";
            ...
            function n(e) {
              ...
              var a = false;
              var i = e.delimiters;
              for (var o = e.delimiters.length, s = 0; s < o; s++) {
                if ((t = i[s]).marker === "->") {
                  r = true;
                } else if (t.marker === "<-") {
                  a = true;
              ...
              if (r && a) {
                for (s = 0; s < o; s++) {
                  if ((t = i[s]).marker === "->") {
                    r = true;
                    (n = e.tokens[t.token]).type = "centertext_open";
                    n.tag = "div";
                    n.nesting = 1;
                    n.markup = "->";
                    n.content = "";
                    n.attrs = [["class", "text-align-center"]];
                  } else if (t.marker === "<-" && r) {
                    (n = e.tokens[t.token]).type = "centertext_close";
                    n.tag = "div";
                    n.nesting = -1;
                    n.markup = "<-";
                    n.content = "";
            ...
            e.inline.ruler.before("emphasis", "centertext", t);
            e.inline.ruler2.before("emphasis", "centertext", n);
          };
        }, {}]
      }, {}, [1])(1);
    };
  ...
  "22": function (e, t, n) {
    ...
    t.default = function () {
      var e = function e(t) {
        var n = function n(e) {
          w = e;
          h.mermaidRender = e.mermaidRender;
          h.md = e;
          g.parseHtml = h;
          if (t) {
            t(e);
      ...
      var r = function r() {
        if (window.mermaid) {
          window.mermaid.initialize({
            startOnLoad: true,
            legacyMathML: true,
            fontFamily: "Helvetica, \"Lantinghei SC\", PingFangSC-light, PingFangTC-light, \"PingFang SC\", Optima-Regular, \"Microsoft Yahei\", \"WenQuanYi Micro Hei\", 微软雅黑, STXihei, \"WenQuanYi Micro Hei\", Arial, sans-serif",
            theme: "default"
          });
        }
      };
      var a = function a(e) {
        functionHook(e, "validateLink", false, function (e, t) {
          if (t[0] && t[0].match(/^data:image\/\w+;/)) {
            return true;
          }
        });
      };
      var l = function l(r, e, t) {
        var a = t.data("_markdownChunkCache") || [];
        var i = e.split("\n");
        var o = [];
        var s = 0;
        var e = u(e);
        _.each(e, function (e, t) {
          var e = e.map[0];
          var n = _.slice(i, s, e).join("\n");
          var n = c(r, n, a);
          o.push(n);
          s = e;
        });
        var e = _.slice(i, s).join("\n");
        o.push(c(r, e, a));
        d(o, t);
        n(t);
        t.data("_markdownChunkCache", o);
      };
      var c = function c(e, t, n) {
        var n = _.find(n, ["text", t]);
        return n || {
          text: t,
          html: "<div data-chunk='1'>" + (n = t == (n = o(e, t)) && n == "<!--" ? htmlEncode(n) : n) + "</div>",
          time: timeFloat()
        };
      };
      var i = true;
      var o = function o(e, t) {
        var n = x.text.indexOf(t);
        if (i && t && n !== -1) {
          r = x.out[n];
          _.pullAt(x.text, n);
          _.pullAt(x.out, n);
      ...
      var u = function u(e) {
        ...
        var n = [];
        for (var r = markdownit().parse(e, {
            references: {}
          }), a = _.keys(t), i = 0; i < r.length; i++) {
          var o = r[i];
          if (!!o.map && o.map[0] != 0 && !(o.level > 0)) {
            if (_.includes(a, o.tag) && o.type == t[o.tag]) {
              n.push(o);
            }
          }
        }
      ...
      var d = function d(e, t) {
        ...
        var a = p(e, a);
        if (a) {
          (n = t.find("[data-chunk]").eq(a.index)).before(a.html);
          n.remove();
        } else {
          r = "";
          _.each(e, function (e) {
      ...
      var n = function n(e) {
        var a = "";
        var i = {};
        e.find("h1,h2,h3,h4,h5,h6").each(function () {
          var e;
          var t = _.trimStart($(this).text(), "#");
          var n = t.replace(/\s+/g, "-");
          i[n] ||= 0;
          i[n]++;
          if (i[n] > 1) {
          ...
          var r = "markdown-menu-" + $(this)[0].tagName.toLowerCase();
          if (!$(this).attr("data-link")) {
            e = "<a class=\"target-menu hidden\" href=\"#" + n + "\">#</a><a name=\"" + n + "\"></a>";
            $(this).attr("data-link", "#" + n);
            $(e).prependTo($(this));
          }
          a += "<li class=\"" + r + "\"><a href=\"#" + n + "\">" + t + "</a></li>";
        });
        e.find(".markdown-menu").html("<ul>" + a + "</ul>");
        return "<div class=\"markdown-menu\"><ul>" + a + "</ul></div>";
      };
      var f = function f(t, n, r) {
        e(function (e) {
          n = n || $("<div class='markdown-box'></div>");
          l(e, t, n);
          e.mermaidRender(n, function () {
            if (r) {
              r(n.html());
            }
          });
      ...
      if (w) {
        h.mermaidRender = w.mermaidRender;
      }
      t(function (e) {
        e = _.trimEnd(e);
        return htmlSafe(e);
  ...
  "220": function (e, t, n) {
    ...
    function r(b, v) {
      return function (e, t) {
        ...
        a = e.pos + 2;
        if ((r = b.helpers.parseLinkLabel(e, e.pos + 1, false)) < 0) {
          return false;
        }
        if ((i = r + 1) < f && e.src.charCodeAt(i) === 40) {
          for (i++; i < f && ((n = e.src.charCodeAt(i)) === 32 || n === 10); i++);
          if (f <= i) {
            return false;
          }
          l = i;
          if ((o = b.helpers.parseLinkDestination(e.src, i, e.posMax)).ok) {
            d = e.md.normalizeLink(o.str);
          ...
          l = i;
          for (; i < f && ((n = e.src.charCodeAt(i)) === 32 || n === 10); i++);
          o = b.helpers.parseLinkTitle(e.src, i, e.posMax);
          if (i < f && l !== i && o.ok) {
            s = o.str;
            i = o.pos;
            for (; i < f && ((n = e.src.charCodeAt(i)) === 32 || n === 10); i++);
          ...
          if (i - 1 >= 0 && (n = e.src.charCodeAt(i - 1)) === 32 && (o = x(e.src, i, e.posMax)).ok) {
            c = o.width;
            u = o.height;
            i = o.pos;
            for (; i < f && ((n = e.src.charCodeAt(i)) === 32 || n === 10); i++);
          }
          if (f <= i || e.src.charCodeAt(i) !== 41) {
            e.pos = p;
            return false;
          }
          i++;
          ...
          for (; i < f && ((n = e.src.charCodeAt(i)) === 32 || n === 10); i++);
          if (i < f && e.src.charCodeAt(i) === 91 && (l = i + 1, (i = b.helpers.parseLinkLabel(e, i)) >= 0)) {
            h = e.src.slice(l, i++);
          } else {
            i = r + 1;
          }
          h = h || e.src.slice(a, r);
          if (!(o = e.env.references[b.utils.normalizeReference(h)])) {
            e.pos = p;
            return false;
          }
          d = o.href;
        ...
        if (!t) {
          e.pos = a;
          e.posMax = r;
          var h = new e.md.inline.State(e.src.slice(a, r), e.md, e.env, l = []);
          h.md.inline.tokenize(h);
          if (v && v.autofill && c === "" && u === "") {
            try {
              var g = y(d);
              var c = g.width;
          ...
          (p = e.push("image", "img", 0)).attrs = o = [["src", d], ["alt", ""]];
          p.children = l;
          if (s) {
            o.push(["title", s]);
          }
    ...
    e.exports = function a(e, t) {
      e.inline.ruler.before("emphasis", "image", r(e, t));
    };
  },
  "221": function (e, t, n) {
    "use strict";
    ...
    function o(e, t, n) {
      ...
      for (var i = e.charCodeAt(t); t < n && i >= 48 && i <= 57 || i === 37;) {
        i = e.charCodeAt(++t);
      }
      a.ok = true;
      a.pos = t;
    ...
    e.exports = function s(e, t, n) {
      ...
      if (!(n <= t) && (a = e.charCodeAt(t)) === 61 && ((a = e.charCodeAt(++t)) === 120 || !(a < 48) && !(a > 57))) {
        t = (r = o(e, t, n)).pos;
        if ((a = e.charCodeAt(t)) === 120) {
          t = (a = o(e, ++t, n)).pos;
          i.width = r.value;
          i.height = a.value;
          i.pos = t;
    ...
    r = function () {
      return function s(r, t, a) {
        ...
        "1": [function (e, t, n) {
          function l(e, t) {
            var n;
            var r = e.attrs[e.attrIndex("href")][1];
            for (var a = 0; a < t.length; ++a) {
              if (!(n = t[a]).pattern || new RegExp(n.pattern).test(r)) {
                return n;
              }
            }
          }
          function c(r, a, i) {
            Object.keys(i).forEach(function (e) {
              var t;
              var n = i[e];
              if ((t = a[r].attrIndex(e = e === "className" ? "class" : e)) < 0) {
                a[r].attrPush([e, n]);
              } else {
                a[r].attrs[t][1] = n;
              }
          ...
          function r(e, o) {
            o = o ? Array.isArray(o) ? o : [o] : [];
            Object.freeze(o);
            var s = e.renderer.rules.link_open || this.defaultRender;
            e.renderer.rules.link_open = function (e, t, n, r, a) {
              var i = l(e[t], o);
              var i = i && i.attrs;
              if (i) {
                c(t, e, i);
          ...
          r.defaultRender = function (e, t, n, r, a) {
            return a.renderToken(e, t, n);
          };
          t.exports = r;
        }, {}]
      }, {}, [1])(1);
  ...
  "223": function (e, t, n) {
    ...
    t.default = function (e) {
      ...
      e.block.ruler.before("paragraph", "noticeboard", function (e, t, n, r) {
        var a;
        var i;
        var o;
        var s;
        return !(e.sCount[t] - e.blkIndent >= 4) && !(i = e.eMarks[t], a = e.bMarks[t] + e.tShift[t], i = (a = e.src.substring(a, i).trim()).substr(0, 2), o = l[i], s = false, r) && !!_.includes(_.keys(l), i) && !((s = e.push("notice_open", "div", 1)).attrs = [["class", "tips-block tips-block-" + o]], s.markup = i, s.map = [t, e.line], (s = e.push("inline", "", 0)).map = [t, e.line], s.content = a.substring(i.length), s.children = [], (s = e.push("notice_close", "div", -1)).markup = i, e.line = t + 1, 0);
      });
      var i = function i(e, t, n, r, a) {
        return a.renderToken(e, t, n);
      };
      e.renderer.rules.table_open = function (e, t, n, r, a) {
        return "<div class=\"table-container\">" + i(e, t, n, r, a);
      };
      e.renderer.rules.table_close = function (e, t, n, r, a) {
        return "</table></div>";
      };
    };
  },
  "224": function (e, t, n) {
    ...
    t.default = function (e) {
      var c = ["flowchart", "sequenceDiagram", "classDiagram", "stateDiagram", "stateDiagram-v2", "erDiagram", "journey", "gantt", "pie", "quadrantChart", "requirementDiagram", "gitGraph", "C4Context", "mindmap", "timeline", "zenuml", "sankey", "sankey-beta", "xychart", "xychart-beta", "block", "block-beta", "packet", "packet-beta", "kanban", "architecture", "architecture-beta", "radar", "radar-beta", "treemap", "treemap-beta", "venn", "venn-beta", "ishikawa", "ishikawa-beta", "treeView", "treeView-beta", "graph", "statement", "C4Deployment"];
      var d = function d(t) {
        t = _.trimStart(t);
        return _.some(c, function (e) {
          return _.startsWith(t, e);
        });
      };
      var p = function p(e) {
        return e = _.includes(e, "->>") || _.includes(e, "-)") ? e : (e = (e = (e = (e = (e = (e = e.replace(/-\>/g, "->>").replace(/\<-/g, "-)")).replace("@startuml", "").replace("@enduml", "")).replace(/\nskinparam.*/g, "")).replace(/\nautonumber.*/g, "")).replace(/\nheader\s.*/g, "")).replace(/\nfooter\s.*/g, "")).replace(/\nnewpage\s.*/g, "");
      };
      e.block.ruler.before("fence", "checkCode", function (r, e, t, n) {
        var a = r.bMarks[e] + r.tShift[e];
        var a = r.src.slice(a, r.eMarks[e]);
        r._fenceCodeEnd = false;
        if (_.trim(a).substr(0, 3) == "```") {
          for (var i = e + 1; i <= t; i++) {
            var o = r.bMarks[i] + r.tShift[i];
            var o = r.src.slice(o, r.eMarks[i]);
            if (_.trim(o) === "```") {
              r._fenceCodeEnd = true;
              break;
            }
          }
        }
        if (r && !r._push) {
          r._push = r.push;
          r.push = function (e, t) {
            var n = r._push.apply(r, arguments);
            if (e == "fence" && t == "code") {
              r.tokens[r.tokens.length - 1]._codeEnd = r._fenceCodeEnd;
            }
            return n;
          };
        }
      ...
      e.renderer.rules.fence = function (e, t, n, r, a) {
        var t = e[t];
        var e = t.info;
        var i = _.trim(t.content);
        if (!t.content) {
          return "";
        }
        if (!t._codeEnd) {
          return (0, h.default)(t.content, e);
        }
        if (e == "svg" || i.substr(0, 4).toLowerCase() == "<svg") {
          return f("svg", i, e, i);
        }
        if (_.includes(["math", "latex", "katex"], e)) {
          try {
            var o = katex.renderToString(i);
            return f("math", i, e, "<p class='katex-display'>" + o + "</p>");
          } catch (u) {}
        }
        if (_.includes(["flowchart", "flow"], e)) {
          var s = UUID();
          var l = $("<div class='div-temp' id='" + s + "'></div>").appendTo("body");
          var c = {
            "line-width": 1.5,
            "font-color": "#333",
            "line-color": "#666",
          ...
          try {
            flowchart.parse(i).drawSVG(s, c);
            o = l.html();
            l.remove();
            return f("flowchart", i, e, o);
          } catch (u) {
            l.remove();
            console.info(u);
          }
        }
        if (_.includes(["abc", "music"], e)) {
          s = UUID();
          l = $("<div class='div-temp' id='" + s + "'></div>").appendTo("body");
          c = {
            "line-width": 1.5,
            "font-color": "#333",
            "line-color": "#666",
          ...
          try {
            ...
            o = l.html();
            l.remove();
            return f("music", i, e, o);
          } catch (u) {
            l.remove();
            console.info(u);
          }
        }
        if (_.includes(["plantuml"], e) || _.startsWith(i, "@startuml")) {
          c = plantuml_imgsrc(i);
          return f("plantuml", i, e, "<img src=\"" + c + "\"/>");
        } else {
          s = d(e);
          o = d(i);
          if (!s && !o && (e == "seq" || e == "sequence")) {
            s = true;
            e = "sequenceDiagram";
          }
          if (s && !o) {
          ...
          if ((e = !e && i.match(/^\s*---\s*\n/) && (l = i.replace(/^\s*---\s*\n([\s\S]*?)\n---\s*\n/, ""), d(l)) ? "mermaid" : e) == "sequenceDiagram") {
            i = p(i);
          }
          if (e == "mermaid" || s || o) {
            return f("mermaid", i, "mermaid", "", "data-mermaid=\"flow-wait\"");
          } else {
            return (0, h.default)(t.content, e);
          }
        }
      };
      var f = function f(e, t, n, r, a) {
        t = (0, h.default)(t, n);
        n = window.LNG || {};
        n = {
          preview: n["common.preview"] || "Preview",
          code: n["common.code"] || "Code",
          copy: n["explorer.copy"] || "Copy",
          copyOK: n["explorer.copyOK"] || "Copy successful!",
          zoomout: n["common.zoomout"] || "Zoom Out",
          zoomin: n["common.zoomin"] || "Zoom In",
          download: n["common.download"] || "Download"
        };
        return "<div class=\"markdown-flow " + e + "-result\" " + (a = a || "data-flow=\"done\"") + " data-view-show=\"preview\">\n\t\t\t<div class=\"flow-toolbar\">\n\t\t\t\t<div class=\"toolbar-group left\">\n\t\t\t\t\t<span class=\"btn-item ripple-item\" data-tool=\"preview\" title=\"" + n.preview + "\" title-timeout=\"200\">\n\t\t\t\t\t\t<i class=\"font-icon ri-eye-line\"></i><b>" + n.preview + "</b>\n\t\t\t\t\t</span>\n\t\t\t\t\t<span class=\"btn-item ripple-item\" data-tool=\"code\" title=\"" + n.code + "\" title-timeout=\"200\">\n\t\t\t\t\t\t<i class=\"font-icon ri-code-s-line\"></i><b>" + n.code + "</b>\n\t\t\t\t\t</span>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"toolbar-group right\">\n\t\t\t\t\t<span class=\"btn-item ripple-item\" data-tool=\"copy\" title=\"" + n.copy + "\" title-timeout=\"200\" data-text=\"" + n.copyOK + "\">\n\t\t\t\t\t\t<i class=\"font-icon ri-file-copy-line\"></i><b>" + n.copy + "</b>\n\t\t\t\t\t</span>\n\t\t\t\t\t<span class=\"btn-item ripple-item\" data-tool=\"download\" title=\"" + n.download + "\" title-timeout=\"200\">\n\t\t\t\t\t\t<i class=\"font-icon ri-download-fill-2\"></i><b>" + n.download + "</b>\n\t\t\t\t\t</span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div class=\"flow-preview\">" + r + "</div>\n\t\t\t<div class=\"flow-code\">" + t + "</div>\n\t\t</div>";
      };
      var u = function u(t) {
        var e;
        var r;
        ...
        var o;
        var s;
        if (window.Events && window.mermaid && t) {
          if (t.data("mermaid-bind")) {
            e = t.data("mermaid-bind");
            if (_.isFunction(e)) {
              return e();
            } else {
              return "";
            ...
            o = function o(e) {
              var n = e ? "%%{init: { \"theme\": \"" + e + "\" } }%%\n" : "";
              t.find(".markdown-flow[data-mermaid='flow-done']").each(function () {
                var t = $(this);
                var e = t.find(".code-view").text();
                mermaid.render(UUID(), n + e).then(function (e) {
                  if (e.svg) {
                    t.find(".flow-preview").html(e.svg);
                  }
                });
              });
            };
            s = function s(e) {
              if (t && t.exists()) {
                ...
                Events.unbind("user.darkModeChange", s);
              }
            };
            t.data("mermaid-bind", i);
            Events.bind("user.darkModeChange", s);
            return i();
          }
        }
      };
      var n = function n(e) {
        e.find(".flow-preview svg").each(function () {
          var e;
          var t;
          if (!$(this).attr("_init") && !$(this).get(0).getAttribute("viewBox")) {
            e = $(this).attr("_init", "1");
            if ((t = [0, 0, parseInt(e.attr("width")) || parseInt(e.width()), parseInt(e.attr("height")) || parseInt(e.height())])[2] && t[3]) {
              e[0].removeAttribute("width");
              e[0].removeAttribute("height");
              e[0].setAttribute("viewBox", t.join(" "));
              e[0].setAttribute("preserveAspectRatio", "xMidYMid meet");
            }
          }
        });
      };
      e.mermaidRender = function (e, a) {
        n(e);
        var i;
        var t = u(e);
        var o = t ? "%%{init: { \"theme\": \"" + t + "\" } }%%\n" : "";
        var t = e.find(".markdown-flow[data-mermaid='flow-wait']");
        var s = t.length;
        var l = 0;
        if (s && window.mermaid) {
          i = function i(e, t, n, r) {
            if (r) {
              console.warn("mermaid render error:", n);
              t = "<div class=\"info-alert info-alert-warning m-10\">" + ((n || "") + "").substr(0, 100) + "...</div>";
              e.attr("data-view-show", "code");
            }
            e.attr("data-mermaid", "flow-done");
            l++;
            if (t) {
              e.find(".flow-preview").html(t);
            }
            if (s == l && a) {
              a();
            }
          ...
          t.each(function () {
            var n = $(this);
            var r = n.find(".code-view").text();
            mermaid.render(UUID(), o + r).then(function (e) {
              i(n, e.svg, e);
            }).catch(function (e) {
              var t = (0, g.default)(r, c);
              mermaid.render(UUID(), o + t).then(function (e) {
                i(n, e.svg, e);
                e = (0, h.default)(t, "mermaid");
                n.find(".flow-code").html(e);
                $("<pre class=\"flow-code-error hidden\">" + htmlEncode(r) + "</pre>").appendTo(n);
              }).catch(function (e) {
                i(n, "", e, true);
              });
            });
  ...
  "225": function (e, t, n) {
    ...
    t.default = function (e, t) {
      var t = t ? _.trim(t) : "";
      var n = "";
      var r = htmlRemoveTags(t).substr(0, 20);
      t = t && ({
        js: "javascript",
        oc: "objectivec"
      }[t] || t);
      ...
      e = _.trim(e);
      if (t && hljs.getLanguage(t)) {
        n = hljs.highlight(e, {
          language: t == "html" ? "php-template" : t
        }).value;
      } else {
        n = (a = hljs.highlightAuto(e)).value;
        t = t || a.language;
      }
      var a = {
        run: "Run",
      ...
      if (window.LNG) {
        a = {
          run: LNG["common.run"],
          copy: LNG["explorer.copy"],
          copyOK: LNG["explorer.copyOK"]
        };
      }
      var r = "<div class=\"code-toolbar\" data-lang=\"" + t + "\"><i></i><i></i><span class=\"code-lang\">" + htmlEncode(r) + "</span><div class=\"code-toolbar-right\"><span class=\"code-wrap ripple-item\"><i class=\"font-icon ri-text-wrap\"></i><b></b></span><span class=\"code-run ripple-item\"><i class=\"font-icon ri-play-fill\"></i><b>" + a.run + "</b></span><span class=\"code-copy ripple-item\" data-text=\"" + a.copyOK + "\"><i class=\"font-icon ri-file-copy-line\"></i><b>" + a.copy + "</b></span></div></div>";
      var a = "<pre class=\"hljs-code lang-" + htmlEncode(t) + "\"><code class=\"hljs\">" + r;
      var t = "</code></pre>";
      if (e.split("\n").length < 5) {
        return a + "<div class=\"code-view code-simple\" style=\"padding:10px;\">" + n + "</div>" + t;
      } else {
        if ((n = n.replace(/<span class="hljs-comment">([\s\S]*?)<\/span>/g, function (e, t) {
          if (e.indexOf("\n") === -1) {
            return e;
          } else {
            return o(t, "<span class=\"hljs-comment\">", "</span>", "\n");
          }
        })).substr(n.length - 1, 1) == "\n") {
          n = n.substr(0, n.length - 1);
        }
        return a + "<ul class=\"code-view\">" + (n = o(n, "<li><span>", "\n</span></li>", "")) + "</ul>" + t;
      }
    };
  ...
  "226": function (e, t, n) {
    ...
    t.default = function (n, e) {
      n = (n = (n = n.replace(/(\[.*)(“|”)(.*\])/g, "$1'$2")).replace(/(“|”)/g, "\"").replace(/(：)/g, ":").replace(/""/g, "\" \"")).replace(/\<i\s*class="rag-use"\s*data-id="\d+">\d+\<\/i\>/g, "");
      var t = _.trimStart(n);
      if (t.match(/^\s*---\s*\n/)) {
        t = t.replace(/^\s*---\s*\n([\s\S]*?)\n---\s*\n/, "");
      }
      ...
      _.each(e, function (e, t) {
        if (_.startsWith(r.toLowerCase(), t.toLowerCase())) {
          n = e(n);
        }
      });
      return n;
    ...
    var i = function i(e, t) {
      ...
      if (e) {
        n = _.trim(e);
        if ((!_.startsWith(n, "\"") || !_.endsWith(n, "\"")) && n.match(/[\u1f00-\uefff]/)) {
          return "\"" + (n = n.replace(/"/g, "'")) + "\"" + (t || "");
        } else {
          return e;
        }
      } else {
    ...
    var o = function o(e) {
      return !_.trim(e) || _.startsWith(_.trim(e), "%%");
    };
    var s = 0;
    var a = function a(e) {
      return e = (e = e.replace(/([\[])(.*?)([\]])/gim, function (e, t, n, r) {
        if (o(e) || _.startsWith(n, "\"") && _.endsWith(n, "\"")) {
          return e;
        } else {
          return t + "\"" + (n = (n = n.replace(/"/g, "'")).replace(/--\>/g, "-- >")) + "\"" + r;
        }
      })).replace(/(\s*-->\s*)(\|.*?\|)?(.*?)(?=-->|$)/gm, function (e, t, n, r) {
        var a = _.trim(r);
        if (a.match(/^[\w\-\~\_\+\?\.\,\u1f00-\uefff]$/) || a.match(/^[\w\-\~\_\+\?\.\,\u1f00-\uefff]+(\[.*\]|\(.*\)|\{.*\})$/)) {
          return e;
        } else {
          r = _.trim(a, "\"").replace(/"/g, "'");
          return t + (n || "") + " _fix" + s++ + "[\"" + r + "\"]";
        }
      });
    };
    var l = function l(e) {
      return e = (e = (e = e.replace(/^(\s*x-axis\s+)(.*?)\[([^\]]*)\](.*)/gm, function (e, t, n, r, a) {
        if (o(e)) {
          return e;
        } else {
          r = _.map(r.split(","), function (e) {
            return i(_.trim(e));
          }).join(",");
          return t + i(n, " ") + "[" + r + "]" + a;
        }
      })).replace(/^(\s*y-axis\s+)(.*?)([0-9\.\-]+\s*-->\s*[0-9\.\-.*]+)/gm, function (e, t, n, r) {
        if (o(e)) {
          return e;
        } else {
          return t + i(n, " ") + r;
        }
      })).replace(/^(\s*)(annotation\s+)(.*)/gm, function (e, t, n, r) {
        if (o(e)) {
          return e;
        } else {
          return t + "%% " + n + r;
    ...
    var c = function c(e) {
      return e = (e = (e = e.replace(/^(\s*x-axis\s+|\s*y-axis\s+)(.*\s*)-->(\s*.*)/gm, function (e, t, n, r, a) {
        if (o(e)) {
          return e;
        } else {
          return t + i(n) + " --> " + i(r);
        }
      })).replace(/^(\s*quadrant-\d\s+)(.*)/gm, function (e, t, n) {
        if (o(e)) {
          return e;
        } else {
          return t + i(n);
        }
      })).replace(/^(\s*)(.*)\s*:\s*(\[[0-9\.\-\s]+,[0-9\.\-\s]+\])(.*)/gm, function (e, t, n, r, a) {
        if (o(e)) {
          return e;
        } else {
          return t + i(n) + ": " + r + a;
    ...
    var u = function u(e) {
      return e = (e = (e = e.replace(/^(\s*)(.*[\(\)\[\]\{\}]+.*)/gm, function (e, t, n) {
        var r;
        if (o(e) || (r = n.match(/^([\w\d \t]+)?[\(\[\{](.*)[\)\]\}]\s*$/)) && r[2] && _.startsWith(r[2], "\"") && _.endsWith(r[2], "\"") || r && r[2] && !r[2].match(/\(\)\[\]\{\}/)) {
          return e;
        } else {
    ...
    var d = function d(e) {
      return e = e.replace(/^(\s*)(.*)(\s*:\s+)(.*)/gm, function (e, t, n, r, a) {
        if (o(e)) {
          return e;
        } else {
          return t + n.replace(/:/g, "#58;") + r + a.replace(/:/g, "#58;");
        }
      });
    };
  },
  "227": function (e, t, n) {
    ...
    t.default = function (e) {
      e.inline.ruler.after("emphasis", "toc", function (e, t) {
        return !t && !((t = (t = /^@?(\[toc\])|(\[\[toc\]\])/im.exec(e.src)) ? t.filter(function (e) {
          return e;
        }) : []).length < 1) && !(e.push("toc_open", "toc", 1).markup = t[0], e.pos = e.pos + t[0].length, 0);
      });
      e.renderer.rules.toc_open = function (e, t) {
        return "<div class=\"markdown-menu\"></div>";
      };
    };
  },
  "228": function (e, t, n) {
    ...
    var i = !(t.default = function (n) {
      var e;
      var r;
      var a;
      if (!i) {
        i = true;
        e = ".markdown-preview-image-show";
        if (!(r = $(e)).exists()) {
          r = $("<div class=\"" + _.trimStart(e, ".") + " hidden\"><div class=\"continer\"></div></div>").appendTo("body");
          ...
          r.bind("click", function () {
            r.fadeOut(100, function () {
              r.find(".continer").html("");
              r.addClass("hidden");
            });
          });
        }
        a = ".markdown-preview .markdown-flow svg,.markdown-preview img";
        n.delegate(a, "click", function (e) {
          var t = $(this);
          if (!t.hasClass("disable-open") && !t.hasClass("emoji-img")) {
            if (window.kodApp && kodApp.appList) {
              if ($(this).parentNode(".markdown-preview")) {
                return core.openImage($(this), n.find(a));
              } else {
                return undefined;
              }
            }
            $(this).clone().appendTo(r.find(".continer"));
            r.removeClass("hidden").hide().fadeIn(100);
          }
        });
      }
    });
  ...
  "229": function (e, t, n) {
    ...
    var i = !(t.default = function () {
      ...
      if (!i && window.$) {
        i = true;
        e = $.isWindowTouch && $.isWindowTouch() ? "touchend" : "click";
        $("body").delegate(".hljs .code-copy", e, function (e) {
          e = $.targetParent(e, ".hljs");
          if (e) {
            $.copyText(e.find(".code-view").text());
            Tips.tips($(this).attr("data-text"));
          }
        }).delegate(".hljs .code-run", e, function (e) {
          e = $.targetParent(e, ".hljs");
          if (e) {
            n(e.find(".code-view").text());
          }
        }).delegate(".hljs .code-wrap", e, function (e) {
          e = $.targetParent(e, ".hljs");
          if (e) {
            e.toggleClass("no-wrap");
          }
        }).delegate(".markdown-flow .btn-item[data-tool]", e, function (e) {
          var t = $(this).attr("data-tool");
          var n = $(this).parents(".markdown-flow").last();
          switch (t) {
            case "preview":
              n.attr("data-view-show", "preview");
              n.parents(".perfectScroll").perfectScroll();
              break;
            case "code":
              n.attr("data-view-show", "code");
              n.parents(".perfectScroll").perfectScroll();
              break;
            case "copy":
              a(n, $(this).attr("data-text"));
              break;
            case "download":
              r(n);
              break;
            case "fullscreen":
              n.find(".flow-preview").find("img,svg").trigger("click");
          }
        });
        a = function a(e, t) {
          var n = e.attr("data-view-show");
          var r = e.find(".code-view").text();
          var e = $.svgToLink(e.find("svg"), 1);
          var n = n == "preview" && e || r;
          Tips.tips(t);
        ...
        r = function r(e) {
          var t = "image-" + dateFormat(time(), "ymdhi") + ".svg";
          $.htmlDownload($.svgToLink(e.find("svg")), t, "image/svg+xml");
        };
        n = function n(e) {
          var t;
          if (window.$ && window.$.artDialog) {
            t = "<iframe frameborder='0' style='width:100%;height:100%;border:0;' sandbox='allow-modals allow-orientation-lock allow-forms allow-scripts allow-popups allow-pointer-lock allow-downloads' allow='midi; geolocation; camera *; microphone; camera; display-capture; encrypted-media; clipboard-read; clipboard-write;' allowfullscreen allowpaymentrequest ></iframe>";
            (t = (window.ShareData ? ShareData.frameTop() : window).$.artDialog({
              fixed: true,
              title: window.LNG && LNG["admin.plugin.defaultHtmlView"] || "HTML预览",
              ...
              resize: true,
              content: t
            })).$main.find(".aui-content iframe").attr("srcdoc", e);
            t.$main.find(".iframe-mask").remove();
          }
        };
      }
    });
  ...
  "602": function (e, t, a) {
    ...
    var r = {
      ...
      preinitialize: function c() {
        if (this.initBefore) {
          this.initBefore.apply(this, arguments);
        }
      },
      extendMethod: function u(e, t) {
        var n;
        var r;
        if (_.isString(t)) {
          t = t.split(",");
        ...
        for (r in t) {
          if (t.hasOwnProperty(r)) {
            if (e[t[r]]) {
              this[r] = _.bind(e[t[r]], e);
            } else {
              console.error("extendMethod error;not font:", e, t[r], r);
            }
          }
        }
      },
      triggerEventFlag: true,
      triggerEventStop: function d() {
    ...
    var n = "each,map,every,some,filter";
    _.each(n.split(","), function (n) {
      r["_" + n] = function (e, t) {
        t = _.isFunction(t) ? _.bind(t, this) : t;
        return _[n](e, t);
      };
    });
    r._delay = function (e, t) {
      var n = this;
      var r = _.slice(arguments, 2);
      var a = roundString();
      var t = setTimeout(function () {
        n._setTimeoutList[a] = null;
        delete n._setTimeoutList[a];
        e.apply(n, r);
      }, t || 0);
      this._setTimeoutList ||= {};
      return this._setTimeoutList[a] = t;
    };
    r._delayClearAll = function () {
      if (!_.isEmpty(this._setTimeoutList)) {
        this._each(this._setTimeoutList, function (e) {
          if (e) {
            clearTimeout(e);
          }
        });
    ...
    _.extend(Backbone.View.prototype, r);
    _.extend(Backbone.Model.prototype, r);
    _.extend(Backbone.Collection.prototype, r);
    _.extend(Backbone.Router.prototype, r);
    var i = window.ClassBase = Backbone.View;
    var o = function o(e, t) {
      if (!window.LNG) {
    ...
    _.extend(Backbone.View.prototype, {
      preinitialize: function c() {
        ...
        this._data_ = {};
        if (e.length > 0 && _.isObject(e[0]) && e[0].parent) {
          this.parent = e[0].parent;
          this._data_.oldSelector = this.el || "";
          this._data_.parent = {
            "__proto__": []
          } instanceof Array ? this.__proto__.__proto__ : this.constructor.prototype.constructor.prototype;
        ...
        if (this.parent) {
          if (this.parent && this.parent.global) {
            ...
            this._each(this.global.autoToChildren, function (e, t) {
              this[t] = e;
            });
          }
        } else {
        ...
        if (this.initBefore) {
          this.initBefore.apply(this, e);
        }
      },
      initialize: function l() {
        Events.trigger("view.initBefore", this);
        this.trigger("view.initBefore", this);
        var e = timeFloat();
        if (this.init) {
          this.init.apply(this, arguments);
        }
        this.trigger("view.initAfter", this);
        Events.trigger("view.initAfter", this);
        this.resetViewTree();
        this.resetViewTreeDelay = setTimeout(_.bind(this.resetViewTree, this), 100);
        if (this.initAfter) {
          this.initAfter.apply(this, arguments);
        }
        this._data_.initUseTime = +((timeFloat() - e) * 1000).toFixed(0);
      },
      initAfter: function f() {},
      onRemove: function h() {},
      resetViewTree: function g() {
        if (this.parent) {
          var e;
          var t = this.cid;
          for (e in this.parent) {
          ...
          this.parent._data_.children[t] = this;
        } else {
          var r = {};
          var a = {};
          var i = function i(e, t) {
            if (t._data_) {
              if (t.$el) {
                t.$el.attr("data-view-node", "1");
                t.$el.data(e, t);
              }
              t.cid = e;
              r[e] = t;
              a[e] = t._data_.initUseTime;
              if (t._data_.children) {
                for (var n in t._data_.children) {
                  i(e + "." + n, t._data_.children[n]);
                }
              }
              if (Backbone.debug && t._initUseTime > 10) {
                console.log(t._data_.cid, t._data_.initUseTime + "ms", e, t);
              }
            }
          };
          this._data_ = this._data_ || {};
          this._data_.allViewTime = a;
          this._data_.allView = r;
          i("root", this);
        }
      },
      renderHtml: function m(e, t, n) {
        e = o(e, t);
        t = this.renderTargetGet(n);
        if (!t) {
          return e;
        }
        t.html(e);
      },
      renderTargetGet: function b(e) {
        var t = this.$el;
        return e !== false && (e && (e instanceof $ ? t = $(e) : _.isString(e) && (t = this.$(e))), t);
      },
      renderMarkdown: function v(e, t, n, r) {
        e = this.renderHtml(e, t, false);
        t = this.renderTargetGet(n);
        new (a(22).default)().parse(e, t, r);
      },
      removeViewAll: function y() {
        var n;
        if (this.$el.length != 0) {
          (n = this).$el.find("[data-view-node]").add(this.$el).each(function () {
            var e;
            if ($(this).attr("data-view-node")) {
              e = $(this).data();
              _.each(e, function (e, t) {
      ...
      objectRemove: function x(e, t) {
        e = e || this;
        t = t == undefined;
        if (e instanceof Backbone.View) {
          if (!e.objectRemoveViewFinished) {
            var n = _.get(e, "_data_.children");
            if (t && n) {
              for (var r in n) {
                this.objectRemove(n[r]);
              }
            }
            this.objectRemoveView(e);
            e.objectRemoveViewFinished = true;
          }
        } else {
          if (e.objectRemove && _.isFunction(e.objectRemove)) {
            e.objectRemove.apply(e);
          }
          console.error("remove Error: is not View;", e);
        }
      },
      objectRemoveView: function w(n) {
        var e = n.cid;
        if (e == "root" && Backbone.debug) {
          console.log("clear:", e, n);
        }
        Events.trigger("view.onRemove", this);
        n.trigger("onRemove");
        n.onRemove();
        if (n.resetViewTreeDelay) {
          clearTimeout(n.resetViewTreeDelay);
        }
        if (n.$el) {
          n.$el.removeAttr("data-view-node", "1");
          n.$el.removeAttr(n.cid);
          n.$el.removeData(n.cid);
          if (!n.ignoreDelegate) {
            n.$el.off().die().undelegate();
          }
        }
        if (n.model) {
          n.model.off(null, null, n);
        }
        if (n.collection) {
          n.collection.off(null, null, n);
        }
        n.undelegateEvents();
        n.off();
        n.stopListening();
        n._delayClearAll();
        Events.unbindByContext(n);
        Router.removeByContext(n);
      ...
      debug: function k() {
        var e = this._data_.allView || this._data_.children;
        if (e) {
          console.log(1010, "debug start;");
          _.forEach(e, function (e, t) {
            e.bind("all", function () {
              var e = _.toArray(arguments);
              console.log("Event@" + t + ":[" + e[0] + "]", e.slice(1));
            });
          });
          window.App = this;
          console.log(1010, e);
    ...
    Backbone.Events.unbindByContext = function (n) {
      var r = this._events;
      _.each(r, function (e, t) {
  ...
  "603": function (e, t, n) {
    ...
    var r = [];
    var a = false;
    ClassBase.extendHook = function (e) {
      if (_.isString(e.hookMatch)) {
        e.hookMatch = e.hookMatch.split(",");
      }
      r.push(e);
      if (!a) {
        Events.bind("view.initBefore", function (t) {
          _.each(r, function (e) {
            if (i(e.hookMatch, t)) {
              s(t, e);
            }
    ...
    var o = function o(e, t) {
      return e.hasOwnProperty(t) || e.__proto__ && e.__proto__.hasOwnProperty(t);
    };
    var i = function i(e, t) {
      var n = true;
      if (t.hookIgnore) {
    ...
    var s = function s(i, e) {
      if (e.hookInitAfter) {
        i.bind("view.initAfter", _.bind(e.hookInitAfter, i));
      }
      _.each(e, function (e, t) {
        var n;
        var r;
        if (t != "hookMatch" && t != "hookInitAfter") {
          if (_.isFunction(e)) {
            if (o(i, t)) {
              n = i[t];
              if (i["__" + t]) {
  ...
  "604": function (e, t, n) {
    ...
    _.extend(Backbone.Router.prototype, {
      ...
      go: function r() {
        ...
        this.navigate.apply(this, e);
        if (e[1] && !e[1].trigger) {
          this.hash = e[0];
        }
      },
      setParam: function o(e, t, n, r) {
        var a;
        if (_.isString(e) && _.isString(t)) {
          (a = this.query || {})[e] = t;
          e = a;
        }
        if (!e || !_.isObject(e)) {
          return this.go(this.hash);
        }
        var i = function i(e) {
          e = urlEncode(e);
          return e = (e = (e = (e = e.replace(/%2F/gi, "/")).replace(/%7B/gi, "{")).replace(/%7D/gi, "}")).replace(/%3A/gi, ":");
        };
        e = _.map(e, function (e, t) {
          if (t && e) {
            if (r) {
              return t + "=" + e;
            } else {
        ...
        e = _.filter(e).join("&");
        var t = this.hash + (e = e ? "&" + e : "");
        this.go.apply(this, [t, n]);
        this.resetHashData();
      },
      setParamAdd: function a(e) {
        var t = _.clone(this.query) || {};
        this.setParam(_.extend(t, e));
      },
      isRefreshing: false,
      refresh: function i() {
      ...
      refreshCurrent: function s() {
        this.isRefreshing = true;
        this.routeRunCallback(this.hash);
        this.isRefreshing = false;
      },
      map: function l(e) {
        var t = this;
        if (_.isArray(e)) {
          _.each(e, function (e) {
            t.mapItem(e.key, e.callback, e.name, e.context);
          });
        } else {
          e = e;
          t.mapItem(e.key, e.callback, e.name, e.context);
      ...
      loadUrl: function u() {
        ...
        var e = this.history;
        this.resetHashData();
        if (this.hashBefore != Router.hash) {
          return !this.ignoreLocation && !!e.matchRoot() && (n = e.fragment = e.getFragment(), void (_.some(this.routeMap, function (e, t) {
            if (e.routeKeyReg.test(n)) {
              e.callback();
              return true;
            }
          }) || this.routeAliasMatch()));
        }
        Events.trigger("router.change");
      },
      routeAliasMatch: function d() {
        for (var e = this.hash, t = []; e.indexOf("/") > 0;) {
        ...
        (n = n.reverse()).push(this.hash);
        if (n.length == 1) {
          i = n[0];
          if (this.routeMap[i]) {
            return this.routeRunCallback(i);
          } else {
        ...
        for (r = 0; r < n.length; r++) {
          var i = n[r];
          if (this.routeMap[i]) {
            this.routeRunCallback(i);
          }
        }
      },
      routeRunCallback: function p(e) {
        if (this.routeMap[e]) {
          this.routeMap[e].callback();
        }
      },
      resetHashData: function f() {
        var e = window.location.hash;
        var t = {};
        var n = decodeURIComponent;
        var r = e.indexOf("?");
        if ((r = r == -1 ? e.indexOf("&") : r) !== -1) {
          for (var a = e.substr(r + 1).split("&"), i = 0; i < a.length; i++) {
            var o = a[i].split("=");
            t[n(o[0])] = n(o[1]);
          }
          e = e.substr(0, r);
        ...
        e = _.trim(e, "/#");
        this.hashBefore = this.hash;
        this.queryBefore = $.objClone(this.query) || {};
        this.hash = e;
        this.query = t;
      },
      removeByContext: function h(n) {
        var r = this;
        _.each(this.routeMap, function (e, t) {
          if (e.contextView == n) {
            delete r.routeMap[t];
          }
        });
      ...
      mapItemViewObject: false,
      mapItem: function g(n, r, e, t) {
        var a = this;
        var i = function i(t) {
          return function () {
            if (t === a.mapItemViewObject && !this.isRefreshing) {
              return a.currentApp;
            }
            if (a.currentApp) {
              a.currentApp.objectRemove();
            }
            var e = _.toArray(arguments);
            var e = [null].concat(e);
            var e = new (Function.prototype.bind.apply(t, e))();
            a.currentApp = e;
            a.mapItemViewObject = t;
            window.App = e;
          };
        };
        var o = this.history;
        var s = this._routeToRegExp(n);
        var l = function l() {
          var e = {
            hash: a.hash,
            route: n,
  ...
  "624": function (e, t, n) {
    ...
    function r() {
      var e;
      var t = {};
      for (e in u.pinyinDict) {
        var n = u.pinyinDict[e];
    ...
    var l = function l(e, t, n) {
      ...
      if (a) {
        if (n || a.split(" ").length == 1) {
          ...
          return (0, i.getPinyinPoly)(e, t, r) || a[0];
        }
      } else {
        return r;
      }
    ...
    function p(a, i, o, s, l) {
      if (a === i.length) {
        s.push(o.join(" "));
      } else {
        var c = function c(e) {
          var t;
          var n = i.substring(a, e + 1);
          var r = false;
          if (u.pinyinAll.some(function (e) {
            ...
            if (n.length === 1) {
              ...
              t = [];
              u.pinyinAll.forEach(function (e) {
                if (e.indexOf(n) === 0) {
                  t.push(e);
                }
              });
            ...
            r = true;
          } else if (u.pinyinAll.indexOf(n) !== -1 && l[e + 1]) {
            o.push(n);
            r = true;
          }
          if (r) {
    ...
    function f(e) {
      ...
      if (r.length === 0 || r[0].length !== e.length) {
        r.push(e.split(""));
      }
      s = a({}, e, r);
      return r;
    ...
    function h(e, t, n, r) {
      var a;
      return !!e && ((a = e.split(" ")).forEach(function (e) {
        if (e.length > 0 && r) {
          a.push(e.charAt(0));
        }
      }), n ? a.some(function (e) {
    ...
    function g(e, t) {
      ...
      if (n !== -1) {
        ...
        return m(e.split(""), [t.split("")], t) || m(c(e), s[t] || f(t), t);
      }
    }
    function m(e, t, n) {
      var r = e.length;
          ...
          for (var l = 0; !(r - l < o);) {
            ...
            for (var p = 0; p < i.length; p += 1) {
              if (p === 0 && e[l + p + u] === " ") {
                ...
                d += 1;
                --p;
              } else if (!h(e[l + p + d], i[p], !e[l + p + 1] || !i[p + 1], s)) {
                l += 1;
                c = false;
                break;
              }
    ...
    var v = function v(e, t) {
      ...
      for (var a = 0; a < t.length; a++) {
        var i = t[a];
        if (i[0] > n) {
          r.push([0, e.substr(n, i[0] - n)]);
        }
        r.push([1, e.substr(i[0], i[1] - i[0])]);
        n = i[1];
        if (a == t.length - 1 && n < e.length) {
          r.push([0, e.substr(n)]);
        }
      }
      return r;
    ...
    t.default = {
      match: g,
      matchFirst: function y(e, t) {
        e = g(e, t);
        return e && e[0] === 0;
      },
      getPinyinPoly: i.getPinyinPoly,
      get: function x(e) {
        var t = "";
        for (var n = 0, r = e.length; n < r; n++) {
          t += l(e, n);
      ...
      getFirst: function w(e) {
        var t = "";
        for (var n = 0, r = e.length; n < r; n++) {
          t += l(e, n).substring(0, 1);
        }
        return t;
      },
      matchAll: function k(e, t) {
        for (var n = [], r = 0, a = g(e, t); a && (n.push([r + a[0], r + a[1]]), r += a[1], e = e.substr(a[1]));) {
          a = g(e, t);
        }
        return b(n);
      },
      matchAllMutil: function $(e, t) {
        var n = [];
        for (var r = 0; r < t.length; r++) {
          var a = _.trim(t[r]);
          if (a &&= Pinyin.matchAll(e, a)) {
            n = _.concat(n, a);
          }
        }
        return b(n);
      },
      matchAllMutilReplace: function T(e, t, n, r) {
        t = _.trim(t);
        var a;
        var i = htmlEncode(e);
        if (t && i && (a = _.filter(t.split(" ")), t.length > 2 && _.startsWith(t, "\"") && _.endsWith(t, "\"") || _.startsWith(t, "'") && _.endsWith(t, "'") ? a = [t.substr(1, t.length - 2)] : window.Intl && Intl.Segmenter && (t = new Intl.Segmenter("cn", {
          granularity: "word"
        }).segment(t), t = Array.from(t), a = [], _.each(t, function (e) {
          if (_.trim(e.segment)) {
            a.push(e.segment);
          }
        })), t = Pinyin.matchAllMutil(e, a))) {
          i = "";
          e = v(e, t);
          _.each(e, function (e) {
            if (e[0]) {
              i += n + htmlEncode(e[1]) + r;
            } else {
              i += htmlEncode(e[1]);
            }
          });
  ...
  "625": function (e, t, n) {
    ...
    a = function a(e) {
      var n = {
        first: (LNG = window.LNG ? LNG : {})["explorer.table.first"] || "首页",
        last: LNG["explorer.table.last"] || "尾页",
        prev: LNG["explorer.table.prev"] || "上一页",
        next: LNG["explorer.table.next"] || "下一页",
        itemPage: LNG["explorer.table.itemPage"] || "条/页",
        page: LNG["explorer.table.page"] || "页",
        items: LNG["explorer.table.items"] || "条记录",
        one: LNG["explorer.table.one"] || "共1页"
      };
      var t = {
        totalNum: 23,
        pageTotal: 12,
        ...
        pageCurrent: 1,
        pageSize: 50,
        pageSizeArray: [20, 50, 100, 200, 500],
        text: {
          first: "<i class='font-icon ri-skip-back-mini-fill' title-timeout=100 title='" + n.first + "'></i>",
          last: "<i class='font-icon ri-skip-forward-mini-fill' title-timeout=100 title='" + n.last + "'></i>",
          prev: "<i class='font-icon ri-arrow-left-s-line' title-timeout=100 title='" + n.prev + "'></i> ",
          next: " <i class='font-icon ri-arrow-right-s-line' title-timeout=100 title='" + n.next + "'></i>",
          pageSize: n.itemPage,
          pageInfo: n.page
        },
        pageInfoShowText: "",
        pageInfoShow: function r(e) {
          var t = "/ " + e.pageTotal + m.text.pageInfo + " <span class=\"grey-6\">(" + e.totalNum + n.items + ")</span>";
          return t = e.pageTotal <= 1 ? n.one + " <span class=\"grey-6\">(" + e.totalNum + " " + n.items + ")</span>" : t;
        },
        animationTime: 100,
        callback: false
      };
      var m = u.extend(true, t, e);
      m.pageSizeArray = e.pageSizeArray || t.pageSizeArray;
      var s = m.pageCurrent <= 1 ? 1 : m.pageCurrent >= m.pageTotal ? m.pageTotal : m.pageCurrent;
      var l = m.pageShow <= 1 ? 1 : m.pageShow >= m.pageTotal ? m.pageTotal : m.pageShow;
      var b = m.pageShow % 2 == 0 ? Math.floor((m.pageShow - 1) / 2) : Math.floor(m.pageShow / 2);
      m.pageInfoShowText = m.pageInfoShow(m);
      var v = u(this);
      var c = function c() {
        var e = "\t\t\t<div class=\"my-page-box\" data-page-total=\"" + m.pageTotal + "\" >\t\t\t\t<div class=\"page-content\">\t\t\t\t\t<div class=\"page-to at-first\" data-page=\"first\"> " + m.text.first + " </div>\t\t\t\t\t<div class=\"page-to\" data-page=\"prev\"> " + m.text.prev + " </div>\t\t\t\t\t<div class=\"page-cover\">\t\t\t\t\t\t<ul>\t\t\t\t\t\t\t<div class=\"page-active-bg\"></div>\t\t\t\t\t\t\t<div class=\"ul-items\">{{pageListHtml}}</div>\t\t\t\t\t\t</ul>\t\t\t\t\t</div>\t\t\t\t\t<div class=\"page-to\" data-page=\"next\"> " + m.text.next + " </div>\t\t\t\t\t<div class=\"page-to at-last\" data-page=\"last\"> " + m.text.last + " </div>\t\t\t\t\t<div class=\"clear\"></div>\t\t\t\t</div>\t\t\t\t<div class=\"page-info\">\t\t\t\t\t<input type=\"text\" value=\"1\">\t\t\t\t\t<span class=\"page-info-text\">" + m.pageInfoShowText + "</span>\t\t\t\t</div>\t\t\t\t<div class=\"page-select\">\t\t\t\t\t<select>{{pageSizeHtml}}</select>\t\t\t\t\t<i class=\"select-icon font-icon x-sort-up-down\"></i>\t\t\t\t</div>\t\t\t\t<div class=\"clear\"></div>\t\t\t</div>";
        var t = "";
        var n = "";
        var r = m.pageSizeArray;
        for (var a = 1; a <= m.pageShow; a++) {
          t += "<li><span class='num-" + a.toString().length + "'>" + a + "</span></li>";
        }
        for (a = 0; a < r.length; a++) {
          n += "<option value='" + r[a] + "'>" + r[a] + " " + m.text.pageSize + "</option>";
        }
        e = (e = e.replace("{{pageListHtml}}", t)).replace("{{pageSizeHtml}}", n);
        v.html(e);
        var i = v.find("input");
        v.find(".my-page-box").delegate("[data-page],.page-cover ul li", "click", function () {
          var e = u(this).attr("data-page");
          var t = parseInt(i.val());
          if (!u(this).hasClass("disable")) {
            switch (e) {
              case "first":
                e = 1;
                break;
        ...
        v.find(".page-to-btn").bind("click", function () {
        ...
        var e = v.find(".page-content ul");
        var o = x(e);
        v.find(".page-cover").width(o * l);
        e.width(o * m.pageTotal);
        v.find(".page-active-bg").css({
          left: "-30px"
        });
        v.find("select").val(m.pageSize);
        w(s, true, 0);
        if (m.pageTotal <= 1) {
          v.find(".my-page-box").addClass("data-only-one-page");
        }
      };
      var y = function y() {
        var e = parseInt(v.find("input").val());
        var t = v.find("select").val();
        if (m.callback) {
          m.callback(e, t);
        }
      };
      var x = function x(e) {
        var e = e.children().first();
        var t = e.innerWidth();
        return t = (t += parseInt(e.css("margin-left")) + parseInt(e.css("margin-right"))) + (parseInt(e.css("border-left-width")) + parseInt(e.css("border-right-width")));
      };
      var w = function w(e, t, n) {
        n = n == undefined ? m.animationTime : n;
        e = (e = isNaN(parseInt(e)) ? 1 : parseInt(e)) <= 1 ? 1 : e >= m.pageTotal ? m.pageTotal : e;
        var r = v.find(".page-content ul");
        var a = x(r);
        var i = parseInt(r.find("li.active").text() || v.find("input").val() || 1);
        var o = m.pageShow;
        var s = "";
        var l = (l = e - o) <= 1 ? 1 : l;
        for (var c = (c = e + o) >= m.pageTotal ? m.pageTotal : c, u = l; u <= c; u++) {
          var d = u.toString().length;
          s += "<li class='page-" + u + "'><span class='num-" + d + "'>" + u + "</span></li>";
        }
        r.find(".ul-items").html(s);
        r.width(a * (c - l + 1));
        if (r.find("page-" + e).hasClass("active")) {
          v.find(".page-info input").val(e);
        } else {
          v.find(".page-content .disable").removeClass("disable");
          if (e <= 1) {
            v.find("[data-page=first],[data-page=prev]").addClass("disable");
          }
          if (e >= m.pageTotal) {
            v.find("[data-page=last],[data-page=next]").addClass("disable");
          }
          if (m.pageTotal <= m.pageShow) {
            v.find("[data-page=prev],[data-page=next]").addClass("hidden");
            v.find("[data-page=first],[data-page=last]").addClass("hidden");
          }
          var o = e - l;
          var p = m.pageTotal > m.pageShow;
          var f = a * o;
          var h = e <= b || !p ? 0 : -a * (o - b);
          var o = i < e ? h + a : h - a;
          if (e >= m.pageTotal - b && p) {
            h = -a * (c - l - m.pageShow + 1);
          }
          if (!p || e <= b + 1 || e >= m.pageTotal - b) {
            o = h;
          }
          r.find("li.active").removeClass("active");
          var g = function g() {
            r.find(".page-active-bg").css({
              left: f
            });
            r.css({
              left: h
            ...
            v.find(".page-info input").val(e);
            r.find("li.page-" + e).addClass("active");
            if (!t) {
              y();
            }
          };
      ...
      var e = v.find(".my-page-box");
      if (e.attr("data-page-total") == m.pageTotal && e.find("option").first().val() == m.pageSizeArray[0]) {
        v.find(".page-info-text").html(m.pageInfoShowText);
        e.find("select").val(m.pageSize);
        w(s, true, 0);
      } else {
        c();
      }
        ...
        if (e && typeof e == "string") {
          ...
          return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, t) {
            ...
            if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(t)) {
              ...
              e = t.indexOf("//") === 0 ? t : t.indexOf("/") === 0 ? n + t : r + t.replace(/^\.\//, "");
  ...
  "735": function (e, t, n) {
    ...
    var c = function c() {
      l = {};
      _.each(d, function (e, a) {
        var i;
        if (a && e && (e = e.split(";"), l[a] = [e[0]], e.length != 1)) {
          i = {};
          l[a].push(i);
          _.each(e, function (e, t) {
            var r;
            if (t !== 0 && (r = e.split(":")).length == 2) {
              r[1] = r[1].split(",");
              _.each(r[1], function (e) {
                var t = e.indexOf(a);
                var n = t == 0 ? e[1] : e[t - 1];
                i[n] ||= [];
                i[n].push([r[0], e.length, t, e]);
              });
            }
          });
        }
    ...
    var u = function u(e, t, n) {
      ...
      if (n.length != 1) {
        var r = n[1];
        var a = t > 0 && r[e[t - 1]];
        if ((a = a || r[e[t + 1]]) && a.length != 0) {
          if (a.length == 1 && a[0][1] == 2) {
            return a[0][0];
          }
          for (var i = 0; i < a.length; i++) {
            var o = a[i];
            var s = e.substr(t - o[2], o[1]);
            if (o[3] == s) {
              return o[0];
            }
          }
  ...
  "743": function (e, t) {
    e.exports = "!function($){$.fn.drag=$.fn.dragTarget;}(jQuery);";
  },
  "744": function (e, t) {
